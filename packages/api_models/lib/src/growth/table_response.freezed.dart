...
/// @nodoc
@JsonSerializable()
class _$TableResponseImpl extends _TableResponse {
  _$TableResponseImpl({this.height, this.time}) : super._();
  ...
  @override
  String toString() {
    return 'TableResponse(height: $height, time: $time)';
  }
...
abstract class _TableResponse extends TableResponse {
  factory _TableResponse({final String? height, final String? time}) =
      _$TableResponseImpl;
  _TableResponse._() : super._();
